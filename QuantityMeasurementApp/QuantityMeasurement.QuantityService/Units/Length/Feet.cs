namespace QuantityMeasurement.QuantityService.Units; // for concrete units

using QuantityMeasurement.QuantityService.Core; // Importing the base logic from the Core.
